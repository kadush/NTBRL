...
$endmonth =  12; 
		...
		$totaltests=getCountytestsdone($countyID,$startmonth,$currentyear);
...
$startmonth =  1; 
 $endmonth =  12;
		...
		$mtbpos=getCountymtbpos($countyID,$startmonth,$currentyear);
...
$startmonth =  1; 
 $endmonth =  12; 
		...
		$mtbneg=getCountymtbneg($countyID,$startmonth,$currentyear);
...
$startmonth =  1; 
 $endmonth =  12; 
		...
		$mtbrif=getCountymtbrif($countyID,$startmonth,$currentyear);
...
<dataset seriesName='Tests With Errors' color='2AD69F' >
<?php   
...
$startmonth =  1; 
 $endmonth =  12; 
		...
		$err=getCountyErrors($countyID,$startmonth,$currentyear);
		
		
?>

<set value='<?php echo $err; ?>' />
<?php
}
?>
</dataset>
