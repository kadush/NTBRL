<?php
	...
	if ($_REQUEST['generatereport'])
    {
		...
		$specificdate = $_POST['specificdate'];
		        ...
		        if($_POST['period'] == 'Monthly'){
		              ...
		              $sql="SELECT lab_no AS a,End_Time AS b, fullname AS c,gender AS d,age AS e, pat_type AS f, mobile AS g, facilitys.name AS h,  Test_Result AS i,mtbRif AS rif,User as j 
							FROM sample1
	...
	$html .= '<h4>'.$countyname.' GeneXpert Register For The Period:  '.$dt.'</h4>';
