...
function tc_setDay(objname, dvalue, path){
	...
	if(!isDateAllow(objname, dvalue, date_array[1], date_array[0])){
		...
		if(isDate(dvalue, date_array[1], date_array[0])){			
			...
			obj.src = path+"../Classes/calendar_form.php?objname="+objname.toString()+"&selected_day="+dvalue+"&selected_month="+date_array[1]+"&selected_year="+date_array[0]+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar+"&inp="+inp+"&fmt="+fmt;
...
function tc_setMonth(objname, mvalue, path){
	...
	if(!isDateAllow(objname, date_array[2], mvalue, date_array[0])){
		...
		if(isDate(date_array[2], mvalue, date_array[0])){
			...
			obj.src = path+"../Classes/calendar_form.php?objname="+objname.toString()+"&selected_day="+date_array[2]+"&selected_month="+mvalue+"&selected_year="+date_array[0]+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar+"&inp="+inp+"&fmt="+fmt;
...
function tc_setYear(objname, yvalue, path){
	...
	if(!isDateAllow(objname, date_array[2], date_array[1], yvalue)){
		...
		if(isDate(date_array[2], date_array[1], yvalue)){
			...
			obj.src = path+"../Classes/calendar_form.php?objname="+objname.toString()+"&selected_day="+date_array[2]+"&selected_month="+date_array[1]+"&selected_year="+yvalue+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar+"&inp="+inp+"&fmt="+fmt;
