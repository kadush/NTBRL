...
$genderC=totalTestsPerCountyByGender($countyID,$filter,$currentmonth,$currentyear,$fromfilter,$tofilter,$fromdate,$todate); 
$hstatusC=totalTestsPerCountyByHStatus($countyID,$filter,$currentmonth,$currentyear,$fromfilter,$tofilter,$fromdate,$todate);
$ptypeC=totalTestsPerCountyByPtype($countyID,$filter,$currentmonth,$currentyear,$fromfilter,$tofilter,$fromdate,$todate);
...
if (isset($_GET['id'])){
   ...
   if ($filter==1)//LAST 3 MONTHS
    ...
    elseif (($filter==0) ||($filter==0) || ($filter==8)) //Lst submitted//all
    {
...
<a href="#" data-rel="close"><i class="entypo-cancel"></i></a>
			...
			<div class="panel-body no-padding">
				<div id="chartnat1"  align="center"> FusionCharts will load here</div>
					<?php if (($ageC[0]==0) and ($ageC[1]==0) and ($ageC[2]==0)) { ?>
		...
		<div class="panel panel-gradient">
			...
			<div class="panel-body no-padding">
				<div id="chartnat2"  align="center">FusionCharts will load here</div>
					...
					<?php if (($genderC[0]==0) and ($genderC[1]==0) and ($genderC[2]==0)) { ?> 
		...
		<div class="panel panel-gradient">
			...
			<div class="panel-body no-padding">
				<div id="chartnat3"  align="center"></div>
				 <?php if (($hstatusC[0]==0) and ($hstatusC[1]==0) and ($hstatusC[2]==0)) { ?> 
