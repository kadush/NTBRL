		...
		<div class="panel panel-gradient" data-collapsed="0">
			...
			<div class="panel-heading">
				<div class="panel-title">
					 <?php echo $cname; ?> County Reporting Form.
				</div>
			...
			<div class="panel-body">
				 <form name="generate" class="TTWForm" method="POST" action="../mpdf/d_rep.php" >
			    <table  class='table table-bordered'   >
	  	 
		<input type="hidden" name="countycode" value="<?php echo $countyID; ?>" />
		<input type="hidden" name="countyname"  value="<?php echo $cname; ?> County" />
		</tr>
