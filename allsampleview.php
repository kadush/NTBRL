...
$query_rssample = "SELECT s.ID as ID,s.lab_no as ln, s.fullname as a, s.age as b, f.name as c, s.End_Time as d, s.Test_Result as e,  s.mtbRif as f 
FROM sample1 s , facilitys f WHERE s.Refacility=f.facilitycode AND s.Test_Result!='ERROR' and s.cond=1 and s.facility=".$_SESSION['mfl'];
	...
	<div class="col-md-12">
		...
		<div class="panel panel-gradient" data-collapsed="0">
			...
			<div class="panel-body">
				...
				?><a href="allsampleview.php" data-rel="close" style="float: right;"><i class="entypo-cancel"></i></a></div>
				<?php } ?>
				<?php if (isset($_GET['suceessmsg']))
						{
						?> 
			 ...
			 <table class="table table-bordered datatable" id="table-1">
				...
				<tbody>
				   <?php do {    $row_rssample['d']= @date('d-M-Y', strtotime($row_rssample['d']));?>      
						...
						<td><a <?php echo "href='sendemail.php?id=" .urlencode($row_rssample['ID']) ."'";?>><img src="img/icons/email4.png" height="20" alt="Email" title="send Email"/></a>    |
							<a <?php echo "href='sendsms.php?id=" .urlencode($row_rssample['ID']) ."'";?>><img src="img/icons/sms.png" height="20" alt="SMS" title="send SMS"/></a>
						</td> 
						 </tr>
