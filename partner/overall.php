...
/* ****************************************************/
$tnat=totalTestsNational1($filter, $currentmonth, $currentyear, $fromfilter, $tofilter, $fromdate, $todate);
$tt=totalTestsByOutcome1($filter, $currentmonth, $currentyear, $fromfilter, $tofilter, $fromdate, $todate);
$age=totalTestsByAge1($filter, $currentmonth, $currentyear, $fromfilter, $tofilter, $fromdate, $todate); 
$gender=totalTestsByGender1($filter, $currentmonth, $currentyear, $fromfilter, $tofilter, $fromdate, $todate);
$hstatus=totalTestsByHStatus1($filter, $currentmonth, $currentyear, $fromfilter, $tofilter, $fromdate, $todate);
$ptype=totalTestsByPtype1($filter, $currentmonth, $currentyear, $fromfilter, $tofilter, $fromdate, $todate);
