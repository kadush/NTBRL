...
/* ****************************************************/
$sql= "SELECT section3.facility AS MFL, facilitys.name AS FACILITY, section3.os  AS OS,section3.ram AS RAM,section3.cpu AS CPU,section3.space AS SPACE FROM section3,facilitys WHERE facilitys.facilitycode=section3.facility AND section3.computer='Yes'"  ;
...
if ($i % 10000 == 0){ 
$dyn_table3 .= '<thead><tr class="odd gradeX"><th><small>Mfl</small></th><th><small>Facility</small></th><th><small>Operating System</small></th><th><small>R.A.M</small></th><th><small>CPU</small></th><th><small>HardDisk Space</small></th></thead> <tbody>';

    $dyn_table3 .= '<td align="left"><small>' .$mfl . '</small></td>';
	$dyn_table3 .= '<td align="left"><small>' .$facility . '</small></td>';
	$dyn_table3 .= '<td align="left" ><small>' .$os. '</small></td>';
    $dyn_table3 .= '<td align="left" ><small>' .$ram. '</small></td>';
	$dyn_table3 .= '<td align="left" ><small>' .$cpu. '</small></td>';
	$dyn_table3 .= '<td align="left" ><small>' .$space. '</small></td></tr>';
