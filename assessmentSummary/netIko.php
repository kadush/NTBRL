...
/* ****************************************************/
$sql= "SELECT section3.facility AS MFL, facilitys.name AS FACILITY, section3.pay  AS PAY,section3.availability AS AVAIL,section3.convenience  AS SPEED FROM section3,facilitys WHERE facilitys.facilitycode=section3.facility AND section3.net_connection='Yes'"  ;
...
if ($i % 10000 == 0){ 
$dyn_table3 .= '<thead><tr class="odd gradeX"><th><small>Mfl</small></th><th><small>Facility</small></th><th><small>Who Pays</small></th><th><small>Day(s) Available</small></th><th><small>Speed</small></th></thead> <tbody>';
	...
	$dyn_table3 .= '<td align="left" ><small>' .$cpu. '</small></td></tr>';
