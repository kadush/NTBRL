...
/* ****************************************************/
$sql= "SELECT section3.facility AS MFL, facilitys.name AS FACILITY, section3.os  AS OS,section3.data AS MODE FROM section3,facilitys WHERE facilitys.facilitycode=section3.facility AND section3.data='Wireless'"  ;
...
if ($i % 10000 == 0){ 
$dyn_table3 .= '<thead><tr class="odd gradeX"><th><small>Mfl</small></th><th><small>Facility</small></th><th><small>Mode of Connection</small></th></thead> <tbody>';

    $dyn_table3 .= '<td align="left"><small>' .$mfl . '</small></td>';
	$dyn_table3 .= '<td align="left"><small>' .$facility . '</small></td>';
	$dyn_table3 .= '<td align="left" ><small>' .$os. '</small></td></tr>';
