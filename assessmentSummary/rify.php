...
/* ****************************************************/
$sql= "SELECT section5.facility AS MFL, facilitys.name AS FACILITY,section5.sampleNO as rif FROM section5,facilitys WHERE facilitys.facilitycode=section5.facility AND section5.rif='Yes'";
...
if ($i % 10000 == 0){ 
$dyn_table3 .= '<thead><tr class="odd gradeX"><th><small>Mfl</small></th><th><small>Facility</small></th><th><small># of Test(s) Referred</small></th></thead> <tbody>';

          $dyn_table3 .= '<td align="left"><small>' .$mfl . '</small></td>';
		  $dyn_table3 .= '<td align="left"><small>' .$facility . '</small></td>';
		   $dyn_table3 .= '<td align="left"><small>' .$rif . '</small></td></tr>';
