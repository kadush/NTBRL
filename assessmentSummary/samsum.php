...
/* ****************************************************/
$sql= "SELECT `section5`.`facility` AS MFL,`facilitys`.`name` AS FACILITY,`section5`.`mtb` AS Det,`section5`.`Rifampicin` AS rif,`section5`.`sampleNO` AS NO
FROM `section5`,`facilitys`
WHERE `section5`.`facility` = `facilitys`.`facilitycode`
...
if ($i % 10000 == 0){ 
$dyn_table3 .= '<thead><tr class="odd gradeX"><th><small>Mfl</small></th><th><small>Facility</small></th><th><small>MTB Detected</small></th><th><small>Rifampicin</small></th><th><small># of Test(s) Referred</small></th></thead> <tbody>';

          $dyn_table3 .= '<td align="left"><small>' .$mfl . '</small></td>';
		  $dyn_table3 .= '<td align="left"><small>' .$facility . '</small></td>';
		  $dyn_table3 .= '<td align="left"><small>' .$det . '</small></td>';
		  $dyn_table3 .= '<td align="left"><small>' .$rif . '</small></td>';
		  $dyn_table3 .= '<td align="left"><small>' .$sample . '</small></td></tr>';
