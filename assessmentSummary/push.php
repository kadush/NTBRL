...
/* ****************************************************/
$sql= "SELECT section6.facility AS MFL, facilitys.name AS FACILITY FROM section6,facilitys WHERE facilitys.facilitycode=section6.facility AND  section6.distribution='Push System'"  ;
