...
/* ****************************************************/
$sql= "SELECT section3.facility AS MFL, facilitys.name AS FACILITY FROM section3,facilitys WHERE facilitys.facilitycode=section3.facility AND section3.policy='No'"  ;
