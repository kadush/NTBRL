...
/* ****************************************************/
$sql= "SELECT section6.facility AS MFL, facilitys.name AS FACILITY,section6.XpertTracking AS XpertTracking FROM section6,facilitys WHERE facilitys.facilitycode=section6.facility "  ;
...
$XpertTracking=$row['XpertTracking'];	
	
	
if ($i % 10000 == 0){ 
$dyn_table3 .= '<thead><tr class="odd gradeX"><th><small>Mfl</small></th><th><small>Facility</small></th><th><small>Method of TB Xpert testing tracking </small></th></thead> <tbody>';

          $dyn_table3 .= '<td align="left"><small>' .$mfl . '</small></td>';
		  
		  $dyn_table3 .= '<td align="left"><small>' .$facility . '</small></td> ';
		  $dyn_table3 .= '<td align="left"><small>' .$XpertTracking . '</small></td> </tr>';
