...
/* ****************************************************/
$sql= "SELECT section5.facility AS MFL, facilitys.name AS FACILITY,section5.rif as rif FROM section5,facilitys WHERE facilitys.facilitycode=section5.facility AND section5.rif='No'";
