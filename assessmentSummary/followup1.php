...
/* ****************************************************/
$sql= "SELECT section2.facility AS MFL, facilitys.name AS FACILITY, section2.followup AS FOLLOW FROM section2,facilitys WHERE facilitys.facilitycode=section2.facility AND section2.followup='Patients told to come back on certain date'"  ;
