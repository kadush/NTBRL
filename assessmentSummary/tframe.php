...
/* ****************************************************/
$sql= "SELECT section6.facility AS MFL, facilitys.name AS FACILITY,section6.timeframe AS TIMEFRAME FROM section6,facilitys WHERE facilitys.facilitycode=section6.facility "  ;
...
if ($i % 10000 == 0){ 
$dyn_table3 .= '<thead><tr class="odd gradeX"><th><small>Mfl</small></th><th><small>Facility</small></th><th><small>Timeframe</small></th></thead> <tbody>';

          $dyn_table3 .= '<td align="left"><small>' .$mfl . '</small></td>';
		  
		  $dyn_table3 .= '<td align="left"><small>' .$facility . '</small></td> ';
		  $dyn_table3 .= '<td align="left"><small>' .$timeframe . '</small></td> </tr>';
