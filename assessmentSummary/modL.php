...
/* ****************************************************/
$sql= "SELECT section3.facility AS MFL, facilitys.name AS FACILITY, section3.os  AS OS,section3.data AS MODE FROM section3,facilitys WHERE facilitys.facilitycode=section3.facility AND section3.data='LAN'"  ;
