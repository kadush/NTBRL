		...
		<div class="row">
			<div class="col-md-12 ">
				<div class="well well-sm">
					<form name="generatereport" id="generatereport" method="POST">
						<!-- <div class="row">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="col-md-1 col-md-offset-3">
									Instrument:
									<select name="device" id="device" class="form-control" required style="min-width: 110px !important">
										<?php
										do {
										?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#getreport").click(function() {
				...
				if (f == 1) {
					var url = '../lab/getinve.php';
				} else {
					var url = '../lab/getinvt.php';
				}
