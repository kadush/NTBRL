...
$sql1 = "SELECT COUNT(DISTINCT district) as district,COUNT(DISTINCT facility) as facility FROM eqa";
$query = mysqli_query($dbConn, $sql1);
$row = mysqli_fetch_assoc($query);
$numrow = $row['district'];
$numrowf = $row['facility'];
...
<div class="row">
	<div class="col-md-3">
			...
			<button class="btn btn-primary popover-primary" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-html="true"
			 data-content="Counties: <?php echo $numrows; ?> <br> Sub counties: <?php echo $numrow; ?> <br> Controlled Labs: <?php echo $numrowf; ?>" data-original-title="Reporting Info">Reporting Information</button>
	...
	<div class="col-md-8 col-md-offset-3">
		...
		<div class="col-md-2">
			<div class="form-group">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="eqarepcounty.php"><input name="getreport" id="getreport" type="button" class="btn btn-info" value="County Summaries" /></a>
			</div>
		</div>
	</div>
</div>
<form id="rootwizard-2" method="post" action="#" class="form-wizard validate">
	...
	<ul>
		...
		<li class="active">
			<a href="#rechecking" data-toggle="tab"><span>1</span>RE-CHECKING OF SPUTUM SMEARS FOR AFB</a>
		</li>
		<li>
			<a href="#NoSmear" data-toggle="tab"><span>2</span>NUMBER OF SMEARS DONE BY THE LAB</a>
		</li>
		<li>
			<a href="#evaluation" data-toggle="tab"><span>3</span>EVALUATION OF SPUTUM SMEAR PREPARATION FOR AFB</a>
		</li>
		<li>
			<a href="#summary" data-toggle="tab"><span>4</span>SUMMARY LABS</a>
		</li>
		<li>
			<a href="#analysis" data-toggle="tab"><span>5</span>ANALYSIS OF UNACCEPTABLE LAB.</a>
		</li>
		<!-- <li>
		<a href="#evaluation" data-toggle="tab"><span>3</span>EVALUATION OF THE MICROSCOPY LABS</a>
	</li> -->
	</ul>

	<div class="tab-content">

		<div class="tab-pane active" id="rechecking">
			<div id="recheckingresult">

			</div>
		</div>
		<div class="tab-pane" id="NoSmear">
			<div id="NoSmearresult">
	...
	$(document).ready(function() {
		...
		$("#getreport").click(function() {
			...
			$.ajax({
				...
				type: "POST",
				url: "recheckingresult.php",
				data: 'qr=' + a + '&yr=' + b + '&sc=' + sc + '&co=' + co + '&level=' + d,
				async: true,
				cache: false,
				success: function(data) {
					$('#recheckingresult').html(data)
				}
			...
			$.ajax({
				...
				type: "POST",
				url: "NoSmearresult.php",
				data: 'qr=' + a + '&yr=' + b + '&sc=' + sc + '&co=' + co + '&level=' + d,
				async: true,
				cache: false,
				success: function(data) {
					$('#NoSmearresult').html(data)
				}
